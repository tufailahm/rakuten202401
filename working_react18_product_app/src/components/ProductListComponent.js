...
const AddProductButton = () => {
  ...
  const handleClick = () => navigate('/products/addProduct');
...
const UpdateProductButton = (props) => {
    console.log("Product id is :"+ props.productId)
    const pId = props.productId
    const navigate = useNavigate();
    const handleClick = () => navigate(`/products/`+pId);
...
{/*                                                 <button className="btn btn-success"
                                                ...
                                                Update</button> */}
                                                <UpdateProductButton productId={product.productId}></UpdateProductButton>
                                                </td>
                ...
                <div className="row">
                        {/* <button className="btn btn-success" onClick={Hello.handleClick}>Add Product</button> */}
